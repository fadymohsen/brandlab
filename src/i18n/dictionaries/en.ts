const en = {
  ...
  about: {
    ...
    paragraph1:
      "Brand Lab was born from a passion for visual storytelling. We believe every brand has a unique story — and the right video can make the world listen. Our team of skilled editors and creative minds work hand-in-hand with startups, freelancers, and content creators to produce videos that don't just look great — they deliver results.",
    paragraph2:
  ...
  pricing: {
    ...
    plans: [
      {
        ...
        features: [
          ...
          { label: "Retention-focused editing", included: false },
          { label: "Trend-based editing", included: false },
      ...
      },
      {
        ...
        features: [
          ...
          { label: "Captions included", included: true },
          { label: "Full content strategy", included: false },
          { label: "Dedicated editor", included: false },
        ],
    ...
    designSection: {
      ...
      titleEnd: "Packages",
      subtitle:
        "Eye-catching social media designs that make your brand stand out. Perfect for posts, ads, and stories.",
      perPack: "/pack",
    ...
    designPlans: [
      {
        name: "Design Starter",
        slug: "design-5",
        price: { EG: "1,499 EGP", INT: "$49" },
        priceRaw: { EG: 1499, INT: 49 },
        count: 5,
        countLabel: "Designs",
        description: "A focused pack to refresh your social presence",
        features: [
          "5 custom social media designs",
      ...
      },
      {
        name: "Design Pro",
        slug: "design-10",
        price: { EG: "2,499 EGP", INT: "$89" },
        priceRaw: { EG: 2499, INT: 89 },
        count: 10,
        countLabel: "Designs",
        description: "More variety for brands posting consistently",
        features: [
          "10 custom social media designs",
          "Carousel & story layouts included",
          "Unlimited minor revisions",
          "Priority turnaround (3-4 days)",
          "Free monthly content calendar",
        ],
        cta: "Order Pack",
        featured: true,
      },
  ...
  coupon: {
    ...
    maxUsesReached: "This coupon has reached its maximum uses",
    wrongPlan: "This coupon is not valid for this plan",
    wrongCurrency: "This coupon is not valid for your region",
    discount: "Discount",
  ...
  contact: {
    ...
    guarantee: "Quick Response Guarantee",
    guaranteeText:
      "We respond to every inquiry within 24 hours. Your project matters to us.",
    form: {
      name: "Your Name",
  ...
  paymentResult: {
    ...
    successMessage: "Your subscription to the {plan} plan has been activated. Our team will reach out to you shortly.",
    pendingTitle: "Payment Pending",
    pendingMessage: "Your payment is being processed. We'll notify you once it's confirmed.",
    failTitle: "Payment Failed",
    failMessage: "Something went wrong with your payment. Please try again.",
    tryAgain: "Try Again",
